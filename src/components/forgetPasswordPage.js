...
class Passwordreset extends React.Component {
  ...
  handleSubmitPage1 = async (e) => {
    ...
    try {
      ...
      if (!data.data.sent) {
        this.setState(() => ({
          error: "Provided email doesnot exist in our database",
        }));
        throw new Error();
      } else {
        this.setState(() => ({
          ...
          isSetPage: 2,
          disablePage1: false,
          successMsg: "OTP has sent to provided email",
        }));
      }
    } catch (e) {
  ...
  handlePasswordUpdate = async (e) => {
    ...
    try {
      ...
      const url = "https://hostel-allotment-api.herokuapp.com/changePassword";
      const credential = {};
      credential.email = this.state.Email;
    ...
    const Page1 = (
      <div className="box">
        ...
        <p className="description-otp">
          Enter your email Id below to get an OTP on your email-id to reset
          password.
        </p>
        <div>
          {this.state.error && (
              ...
              <div className="right-float">
                <span className="margin-float">
                  <input
                    ...
                    value="Verify OTP"
                    disabled={
                      this.state.otp.length !== 6 || this.state.disablePage2a
                    }
                  />
                </span>
              </div>
    ...
    const Page3 = (
      <div className="box">
        ...
        >
          ...
          <br />
          <label htmlFor="re_newPassword">Re-enter New Password:</label>
          <br />
          <input
            className="input-email"
            type="password"
